...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 99.0, 105.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 30.0, 52.0, 157.0, 36.0 ],
									"text" : "route button_right_shoulder button_start"
								}
...
,
					"patching_rect" : [ 418.0, 15.0, 69.0, 22.0 ],
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 95.0, 105.0, 30.0, 30.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 30.0, 52.0, 149.0, 36.0 ],
									"text" : "route button_left_shoulder button_back"
								}
...
,
					"patching_rect" : [ 418.0, 45.0, 68.0, 22.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : ""
					}
,
...
,
					"patching_rect" : [ 314.0, 45.0, 90.0, 22.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : ""
					}
,
...
,
					"patching_rect" : [ 314.0, 15.0, 90.0, 22.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : ""
					}
,
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 147.5, 152.0, 40.0, 50.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 87.5, 152.0, 45.0, 50.0 ],
									"text" : "scale -1. 1. 0 127"
								}
...
,
					"patching_rect" : [ 88.0, 45.0, 180.0, 22.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : ""
					}
,
...
,
					"patching_rect" : [ 88.0, 15.0, 210.0, 22.0 ],
					"saved_object_attributes" : 					{
						"globalpatchername" : ""
					}
,
